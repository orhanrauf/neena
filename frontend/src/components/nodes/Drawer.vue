  ...
  <teleport to="body">
    <el-drawer v-model="show" direction="rtl">
      ...
      <p class="font-weight-light text-sm-body-1">
        ...
        fruitcake cookie. Dessert topping pie. Jujubes wafer carrot cake jelly.
        Bonbon jelly-o jelly-o ice cream jelly beans candy canes cake bonbon.
        Cookie jelly beans marshmallow jujubes sweet.
      </p>
      ...
      <div class="mt-8 d-flex justify-space-between align-center">
        <div>
          ...
          <p class="mb-0">detail: <span style="color: #67b6f0">object</span></p>
        </div>
