...
class TaskOperation(Base):
    ...
    sorted_index: Mapped[int] = mapped_column(Integer, nullable=True)
    ...
    is_instance_of: Mapped["TaskDefinition"] = relationship(
        back_populates="has_instances", foreign_keys="TaskOperation.task_definition"
    )

    created_by: Mapped["User"] = relationship(
        back_populates="created_task_operations", foreign_keys="TaskOperation.created_by_email"
    )
    modified_by: Mapped["User"] = relationship(
        back_populates="modified_task_operations", foreign_keys="TaskOperation.modified_by_email"
    )

    __table_args__ = (UniqueConstraint("index", "flow", name="_index_flow_uc"),)
