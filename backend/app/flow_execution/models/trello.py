...
class TrelloCard(BaseAPIModel):
    ...
    creation_method: Optional[StrictStr] = Field(
        default=None, description="Method used for card creation", alias="creationMethod"
    )
    date_last_activity: Optional[datetime] = Field(
        default=None, description="Last activity date of the card", alias="dateLastActivity"
    )
    ...
    due_reminder: Optional[StrictStr] = Field(
        default=None, description="Reminder setting for the due date", alias="dueReminder"
    )
    ...
    id_attachment_cover: Optional[str] = Field(
        default=None, description="ID of the cover attachment", alias="idAttachmentCover"
    )
    location_name: Optional[StrictStr] = Field(
        default=None, description="Name of the location associated with the card", alias="locationName"
    )
    manual_cover_attachment: Optional[StrictBool] = Field(
        default=None, description="Whether the cover attachment is set manually", alias="manualCoverAttachment"
    )
...
class TrelloCardCreate(BaseIntegrationActionModel):
    ...
    id_list: Optional[str] = Field(
        default=None, description="The ID of the list the card should be created in", alias="idList"
    )
...
class TrelloCardUpdate(BaseIntegrationActionModel):
    ...
    id_attachment_cover: Optional[str] = Field(
        default=None, description="The ID of the image attachment the card should use as its cover, or null for none"
    )
    ...
    pos: Optional[Any] = Field(
        default=None, description="The position of the card in its list. `top`, `bottom`, or a positive float"
    )
    due: Optional[date] = Field(default=None, description="When the card is due, or `null`")
    start: Optional[date] = Field(default=None, description="The start date of a card, or `null`")
    due_complete: Optional[StrictBool] = Field(
        default=None, description="Whether the due date should be marked complete"
    )
    subscribed: Optional[StrictBool] = Field(
        default=None, description="Whether the member is should be subscribed to the card"
    )
    ...
    coordinates: Optional[StrictStr] = Field(
        default=None, description="For use with/by the Map View. Should be latitude,longitude"
    )
...
class TrelloListCreate(BaseIntegrationActionModel):
    ...
    id_board: StrictStr = Field(description="The ID of the board the list should be created in", alias="idBoard")

    pos: Optional[Any] = Field(
        default=None, description="Position of the list in the board. `top`, `bottom`, or a positive float"
    )
...
class TrelloListUpdate(BaseIntegrationActionModel):
    ...
    id_board: Optional[str] = Field(
        default=None, description="ID of a board the list should be moved to", alias="idBoard"
    )
    pos: Optional[Any] = Field(
        default=None, description="New position for the list: `top`, `bottom`, or a positive floating point number"
    )


class TrelloCardsInListGet(BaseIntegrationActionModel):
    """
    Model for retrieving all cards in a specific Trello List.
    """

    id: str = Field(None, description="The ID of the list to retrieve cards from")
...
class TrelloBoard(BaseAPIModel):
    ...
    desc: Optional[str] = Field(default=None, description="The new description of the board")
    desc_data: Optional[dict] = Field(default=None, description="The new descData of the board", alias="descData")
    closed: Optional[StrictBool] = Field(default=None, description="Whether the board should be closed/archived")
    id_member_creator: Optional[str] = Field(
        None, description="The new idMemberCreator of the board", alias="idMemberCreator"
    )
    id_organization: Optional[str] = Field(
        None, description="The new idOrganization of the board", alias="idOrganization"
    )
    ...
    memberships: Optional[Any] = Field(default=None, description="The new memberships of the board")
    short_link: Optional[StrictStr] = Field(
        default=None, description="The new shortLink of the board", alias="shortLink"
    )
    subscribed: Optional[StrictBool] = Field(default=None, description="Whether the user is subscribed to the board")
    power_ups: Optional[Any] = Field(default=None, description="The new powerUps of the board", alias="powerUps")
    date_last_activity: Optional[datetime] = Field(
        default=None, description="The new dateLastActivity of the board", alias="dateLastActivity"
    )
    date_last_view: Optional[datetime] = Field(
        default=None, description="The new dateLastView of the board", alias="dateLastView"
    )
    id_tags: Optional[Any] = Field(default=None, description="The new idTags of the board", alias="idTags")
    date_plugin_disable: Optional[datetime] = Field(
        default=None, description="The new datePluginDisable of the board", alias="datePluginDisable"
    )
    creation_method: Optional[StrictStr] = Field(
        default=None, description="The new creationMethod of the board", alias="creationMethod"
    )
    template_gallery: Optional[StrictStr] = Field(
        default=None, description="The new templateGallery of the board", alias="templateGallery"
    )
    enterprise_owned: Optional[StrictBool] = Field(
        default=None, description="Whether the board is enterprise owned", alias="enterpriseOwned"
    )
...
class TrelloBoardCreate(BaseIntegrationActionModel):
    ...
    default_labels: Optional[StrictBool] = Field(
        default=None, description="Determines whether to use the default set of labels.", alias="defaultLabels"
    )
    default_lists: Optional[StrictBool] = Field(
        default=None,
...
class TrelloBoardUpdate(BaseIntegrationActionModel):
    ...
    desc: Optional[StrictStr] = Field(
        default=None, description="A new description for the board, 0 to 16384 characters long"
    )
...
class TrelloListsInBoardGet(BaseIntegrationActionModel):
    """
    Model for retrieving all lists in a specific Trello Board.
    """

    id: str = Field(None, description="The ID of the board to retrieve lists from")
